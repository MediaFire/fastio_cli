...
/// server independently rejects non-printable / over-length keys (error
/// `128636`); this guard only catches the empty case.
...
/// URL-encoded (`mention%3A123…`) per the published API docs. Both ids are
/// URL-encoded.
